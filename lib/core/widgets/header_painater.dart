...
class AddImageInCourse extends StatefulWidget {
  const AddImageInCourse({super.key});

  @override
  State<AddImageInCourse> createState() => _AddImageInCourseState();
}

class _AddImageInCourseState extends State<AddImageInCourse> {
  @override
  Widget build(BuildContext context) {
